...
In terms of the normative acts regulating the organization and operation of the public authority or institution, statistically significant differences emerge (\(\chi\)^2^(`r df.chi.1`)=`r chi.1`, p=`r p.chi.1`), driven by the rank of the administrative-territorial unit. Indeed, it appears that these types of normative acts are less likely to exist at the level of villages (`r vil.n.1`%  "No" versus `r vil.y.1`% "Yes") compared to towns (`r cit.n.1`% versus `r cit.y.1`% "Yes") and municipalities (`r mun.n.1`% "No" versus `r mun.y.1`%  "Yes"), with statistically significant differences only between villages and the other two categories of administrative units (see figures \@ref(fig:Moz-Range-I1) și \@ref(fig:Bar-Range-I1)).
...
# Analiza contingenței în funcție de regiunea de dezvoltare a României 
